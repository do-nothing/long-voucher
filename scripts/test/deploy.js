...
async function main() {
  ...
  const productCenter = await upgrades.deployProxy(productCenterFactory, [longVoucher.address, recommendationCenter.address, filForwarder.address, deployer.address]);
